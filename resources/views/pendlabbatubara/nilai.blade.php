            ...
            <div class="col-lg-12 .col-md-offset-4">
                ...
                <table border=1>
                    <tr>
                        ...
                        <td><h4 style="padding-left: 10px; padding-right: 10px">{{$pendlabbatubara->nama}}</h4></td>
                    </tr>
                    <tr>
                        <td><h4 style="padding-left: 10px; padding-right: 10px">Jabatan - NIP</h4></td>
                        <td><h4 style="padding-left: 10px; padding-right: 10px">{{$pendlabbatubara->jabatan}} - {{$pendlabbatubara->nik}}</h4></td>
                    </tr>
                    <tr>
                        <td><h4 style="padding-left: 10px; padding-right: 10px">Tanggal Mulai Kerja</h4></td>
                        <td><h4 style="padding-left: 10px; padding-right: 10px">{{$pendlabbatubara->mulaiKerja->format('d-m-Y')}}</h4></td>
                    </tr>
                </table>
                <input id="idpeg" type="hidden" value={{$pendlabbatubara->id}}>
